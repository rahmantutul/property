    ...
    <div class="content-body">
        ...
        <div class="row" id="basic-table">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form class="row" id="ajax_form" action="{{ route('admin.property.store') }}" method="POST"
                            ...
                            <div class="col-4 form-group">
                                ...
                                <input type="text" name="streetNumber" placeholder="Property Titile" class="form-control"
                                    required>
                                <span style="color:red"></span>
                            </div>
                            <div class="col-4 form-group">
