...
@section('title','Buyer Info Update')
@section('content')

<div class="row mb-1">
    <div class="col-8">
    <h2 class="content-header-title float-left mb-0">Buyer Update</h2>
    </div>
...
<div class="content-body">
    ...
    <div class="row" id="basic-table">
        <div class="col-12">
            <div class="card">           
                <div class="card-body">
                    <form class="row" id="ajax_form" action="{{route('admin.buyer.update')}}" method="POST" enctype="multipart/form-data">
                        @csrf
