<div class="modal-dialog modal-dialog-top modal-lg" role="document">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form class="row" id="ajax_form" action="{{route('admin.category.update')}}" method="POST">
                @csrf
                <input type="hidden" name="dataId" value="{{$dataInfo->id}}">
                <div class="col-12 form-group">
                    <strong>Category Name</strong>
                    <input type="text" name="name" placeholder="Category Name" value="{{ $dataInfo->name }}"  class="form-control" required>
