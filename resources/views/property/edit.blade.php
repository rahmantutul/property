                ...
                <div class="card-body">
                    <form class="row" id="ajax_form" action="{{route('admin.property.update')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-4 form-group">
                            <strong>Title:</strong>
                            <input type="text" name="title" placeholder="Property Titile" class="form-control" required value="{{$dataInfo->titile}}" 
                            >
                        ...
                        <div class="col-4 form-group">
                            ...
                            <input type="date" name="expiredDate" placeholder="Expired Date" class="form-control"   value="{{$dataInfo->expiredDate}}" required>
                             <span style="color:red" ></span>
                        </div>
                        ...
                        <div class="col-4 form-group">
                            ...
                            <input type="text" name="streetNumber" placeholder="Street Number " class="form-control"  value="{{(!is_null($dataInfo->address)) ? $dataInfo->streetNumber:''}}" required >
                             <span style="color:red" ></span>
                        </div>
                        <div class="col-4 form-group">
                            <strong>Street Address 1:</strong>
                            <input type="text" name="streetAdressOne" placeholder="Stress Address One" class="form-control" value="{{(!is_null($dataInfo->address)) ? $dataInfo->streetAdressOne:''}}"   required>
                             <span style="color:red" ></span>
                        </div>
                        <div class="col-4 form-group">
                            <strong>Street Address 2:</strong>
                            <input type="text" name="streetAdressTwo" placeholder="Stress Address Two" class="form-control" value="{{(!is_null($dataInfo->address)) ? $dataInfo->streetAdressTwo:''}}"   required>
                             <span style="color:red" ></span>
                        </div>
                        <div class="col-4 form-group">
                            <strong>Suit/Apertment:</strong>
                            <input type="text" name="shuitAppertment" placeholder="Suit apertment" class="form-control" value="{{(!is_null($dataInfo->address)) ? $dataInfo->shuitAppertment:''}}"   required>
                             <span style="color:red" ></span>
                        </div>
                        <div class="col-4 form-group">
                            <strong>Subdivision:</strong>
                            <input type="text" name="subDivision" placeholder="Subdivition" class="form-control" value="{{(!is_null($dataInfo->address)) ? $dataInfo->subDivision:''}}"   required>
                             <span style="color:red" ></span>
                        </div>
                        <div class="col-4 form-group">
                        ...
                        <div class="col-4 form-group">
                            ...
                            <input type="number" name="bedroom" placeholder="Number Of Bedroom" class="form-control" value="{{(!is_null($dataInfo->details))?$dataInfo->details->bedroom:''}}"  required>
                             <span style="color:red" ></span>
                        </div>
                        <div class="col-4 form-group">
                            <strong># Of Bathroom:</strong>
                            <input type="number" name="bathroom" placeholder="Number Of Bathroom" class="form-control"  value="{{(!is_null($dataInfo->details))?$dataInfo->details->bathroom:''}}" required>
                             <span style="color:red" ></span>
                        </div>
                        <div class="col-4 form-group">
                        ...
                        <div class="col-4 form-group">
                            <strong>SQ Ft.:</strong>
                            <input type="number" name="sqFit" placeholder="Square Fit" class="form-control"  value="{{(!is_null($dataInfo->details))?$dataInfo->details->squareFeet:''}}"  required>
                             <span style="color:red" ></span>
                        </div>
                        <div class="col-4 form-group">
                        ...
                        <div class="col-4 form-group">
                            ...
                            <input type="number" name="lotAcres" placeholder="Lot Acres" class="form-control"  value="{{(!is_null($dataInfo->details))?$dataInfo->details->lotAcre:''}}"  required>
                             <span style="color:red" ></span>
                        </div>
                        <div class="col-4 form-group">
                            <strong>Lot Type:</strong>
                            <input type="text" name="lotType" placeholder="Lot Type" class="form-control"  value="{{(!is_null($dataInfo->details))?$dataInfo->details->lotAcre:''}}"  required>
                             <span style="color:red" ></span>
                        </div>
                        <div class="col-4 form-group">
                            <strong>Heat:</strong>
                        ...
                        <div class="col-6 form-group">
                            ...
                            @if(!is_null($dataInfo->thumbail))
                                <img src="{{getImage($dataInfo->thumbail)}}" height="70" width="70">
                                <input type="hidden" name="thumbailUrl" value="{{$dataInfo->thumbail}}">
                            @endif
