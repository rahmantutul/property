                            ...
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                ...
                                <form class=" mt-2" action="{{ route('login') }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        <label class="form-label" for="login-email">Email/Phone</label>
                                        <input class="form-control" id="login-emaila" type="text"  placeholder="john@example.com" aria-describedby="login-email" autofocus="" tabindex="1"  name="userName" value="{{request()->userName}}" required/>
                                    </div>
                                    <div class="form-group">
