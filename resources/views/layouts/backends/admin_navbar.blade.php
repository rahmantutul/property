        ...
        <div class="navbar-container d-flex content">
            ...
            <ul class="nav navbar-nav align-items-center ml-auto">
                ...
                <li class="nav-item dropdown dropdown-user"><a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="javascript:void(0);" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <div class="user-nav d-sm-flex "><span class="user-name font-weight-bolder">{{Auth::guard('admin')->user()->full_name}}</span><span class="user-status  badge badge-info">Admin</span></div><span class="avatar"><img class="round" src="{{getUserImage(Auth::guard('admin')->user()->avatar)}}" alt="{{Auth::user()->full_name}}" height="50" width="50"><span class="avatar-status-online"></span></span>
                    </a>
